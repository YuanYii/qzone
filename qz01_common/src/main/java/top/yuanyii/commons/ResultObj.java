...
public class ResultObj {
    ...
    public static final ResultObj SEND_ERROR=new ResultObj(Constast.ERROR, "发送失败");
    ...
    public static final ResultObj UPDATE_PASSWORD_SUCCESS=new ResultObj(Constast.OK, "修改成功,请重新登录");
    public static final ResultObj UPDATE_PASSWORD_ERROR=new ResultObj(Constast.ERROR, "修改失败");
    public static final ResultObj UPDATE_PASSWORD_OLD_ERROR=new ResultObj(Constast.ERROR, "原密码不正确");
    public static final ResultObj UPDATE_PASSWORD_NOTMATCH=new ResultObj(Constast.ERROR, "两次密码输入不一致");
